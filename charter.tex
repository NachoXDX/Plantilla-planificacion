...
\begin{enumerate}
	...
	\item Requerimiento de \textit{testing}:
		\begin{enumerate}
			...
			\item Se deberá corroborar la consistencia de las \textit{APIs}.
		\end{enumerate}
	...
	\item Requerimientos interoperabilidad:
		\begin{enumerate}
			\item El sistema deberá tener una \textit{API web}.
			\item El sistema deberá tener una \textit{API Python}.
			\item El sistema deberá tener una \textit{API ROS2}.
		\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item ``Como usuario quiero ver el resultado que produciría la salida estimada."

\textit{Story points}: 13 (complejidad: 3, dificultad: 3, incertidumbre: 3)

\item ``Como usuario quiero reentrenar el modelo de forma rápida."

\textit{Story points}: 8 (complejidad: 2, dificultad: 2, incertidumbre: 4)

\item ``Como usuario quiero incorporar el proyecto en mi sistema existente."

\textit{Story points}: 8 (complejidad: 2, dificultad: 1, incertidumbre: 4)

\item ``Como usuario quiero contar con una interfaz grafica en la que pueda interactuar con el sistema."

\textit{Story points}: 5 (complejidad: 1, dificultad: 1, incertidumbre: 3)

\item ``Como ingeniero quiero saber las métricas de desempeño del sistema."

\textit{Story points}: 13 (complejidad: 3, dificultad: 3, incertidumbre: 3)

\item ``Como ingeniero quiero que el sistema actué de forma segura cuando las posiciones son inalcanzables."
...
\item Desarrollo de interfaces (90 h).
	\begin{enumerate}
	\item Desarrollo de \textit{API web} (20 h).
	\item Desarrollo de \textit{API ROS2} (20 h).
	\item Desarrollo de \textit{API Python} (20 h).
